...
const About = () => {
    ...
    const [btnLogo, setBtnLogo] = useState('dark_mode');
    ...
    return(
        <>
            ...
            <button onClick={toggleDarkLightMode} className='btn btn-primary darkLightModeBtn' style={myStyle}><span className="material-symbols-outlined darkLightLogo">{btnLogo}</span> {btnText}</button>
        </>
    )
}
